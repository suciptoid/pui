...
var Select = class extends ViewHook2 {
  expanded = false;
  placement = "bottom-start";
  activePlacement = "bottom-start";
  strategy = "absolute";
...
var LoadingBar = class extends ViewHook3 {
  progress = 0;
  delay = 300;
  delayTimer = null;
  raf = null;
...
var Tooltip = class extends ViewHook4 {
  placement = "top";
  delay = 300;
  hovering = false;
  #clear_floating;
...
var FlashGroup = class extends ViewHook5 {
  max_flashes = 3;
  flash_timeout = 5;
...
var Tabs = class extends ViewHook6 {
  #clickHandler;
  #keyDownHandler;
  #focusHandler;
  mounted() {
